...
class Ratings
{
	...
	{
		return (FlxG.save.data.npsDisplay ? LangUtil.getString('cmnNPS') + ": " + nps + " (" + LangUtil.getString('cmnMaxNPS') + " " + maxNPS + ")"
			...
			+ (!FlxG.save.data.botplay ? // NPS Toggle
				...
				+ // Score
				" | "
				+ LangUtil.getString('cmnComboBreak')
				+ ":"
				+ PlayState.misses
				+ // Misses/Combo Breaks
				" | "
				+ LangUtil.getString('cmnAccuracy')
				+ ":"
